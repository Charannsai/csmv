        ...
        <footer className="bg-black border-t border-white/10 text-[#86868B] relative overflow-hidden">
            <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8 relative z-10">
                <div className="xl:grid xl:grid-cols-4 xl:gap-8">
                    <div className="space-y-8 xl:col-span-1">
                        ...
                        <p className="text-sm leading-6 max-w-xs">
                            Product engineering, technology modernization, and dedicated engineering teams.
                        </p>
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li><Link href="/services" className="hover:text-white transition-colors">Product Engineering</Link></li>
                                    <li><Link href="/services" className="hover:text-white transition-colors">Tech Modernization</Link></li>
                                    <li><Link href="/services" className="hover:text-white transition-colors">Dedicated Teams</Link></li>
                                    <li><Link href="/services" className="hover:text-white transition-colors">Architecture Consulting</Link></li>
                                </ul>
                            </div>
                ...
                <div className="mt-16 border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between">
                    <p className="text-sm">
                        &copy; {new Date().getFullYear()} CSMV Solutions. All rights reserved.
                    </p>
